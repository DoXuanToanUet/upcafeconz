...
<div class="content-body">
    <div class="container-fluid">
		<div class="row page-titles">
			<ol class="breadcrumb">
				<li class="breadcrumb-item active"><a href="javascript:void(0)">Catering Banners</a></li>
			</ol>
        </div>
			...
			<div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
						...
						<button type="button" class="btn btn-rounded btn-primary new-banner-modal" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg" data-page="5">

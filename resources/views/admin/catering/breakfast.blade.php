...
<div class="content-body">
    <div class="container-fluid">
		<div class="row page-titles">
			<ol class="breadcrumb">
				<li class="breadcrumb-item active"><a href="javascript:void(0)">Breakfast</a></li>
			</ol>
        </div>
        ...
        <div class="row">
			...
			<div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Finger Food</h4>
                    ...
                    <div class="card-body">
						@if(isset($data['finger-food']) && count($data['finger-food']) > 0)
			...
			<div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
						@if(isset($data['buffet']) && count($data['buffet']) > 0)
							<div class="table-responsive">
								<table class="table table-responsive-md">
									<thead>
										<tr>
			...
			<div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Buffet Setup</h4>
			...
			<div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
						@if(isset($data['additional-options']) && count($data['additional-options']) > 0)
							<div class="table-responsive">
								<table class="table table-responsive-md">
									<thead>
										<tr>
    ...
    <div class="modal-dialog modal-lg">
        <form class="modal-content" id="catering">
            ...
            <div class="modal-footer">
                <input type="hidden" name="grandparent" value="breakfast">
